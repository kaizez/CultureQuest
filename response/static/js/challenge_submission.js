document.addEventListener('DOMContentLoaded', function () {
    ...
    const { submission_type, project_title, reflection_story, confirmation_check, errors_present, has_server_errors, recaptcha_site_key } = flaskData;
    ...
    if (submitBtn) {
        submitBtn.addEventListener('click', (event) => {
            ...
            grecaptcha.ready(function() {
                grecaptcha.execute(recaptcha_site_key, {action: 'submit_challenge'}).then(function(token) {
