...
class Challenge(db.Model):
    ...
    participants = db.Column(db.String(50), nullable=False)
    ...
    your_progress_next_steps = db.Column(db.Text, nullable=True)
    resources_for_you = db.Column(db.Text, nullable=True)
